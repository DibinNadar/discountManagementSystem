...
//import discountManagementSystem.api.TransactionController;
...
//                linkTo(methodOn(TransactionController.class).getOne(entity.getSerialNo())).withSelfRel(),
//                linkTo(methodOn(TransactionController.class).getAll()).withRel("transactions"));
//    }
//}
